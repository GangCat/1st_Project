...
public enum EBarrackCommand { NONE = -1, CANCLE, SPAWN_UNIT, RALLYPOINT, DEMOLITION, UPGRADE, RALLYPOINT_CONFIRM_TR, RALLYPOINT_CONFIRM_POS, UPGRADE_RANGED_UNIT_DMG, UPGRADE_RANGED_UNIT_HP, UPGRADE_MELEE_UNIT_DMG, UPGRAGE_MELEE_UNIT_HP, LENGTH }
