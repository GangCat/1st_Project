...
public enum EHUDCommand { NONE = -1, ADD_STRUCTURE_NODE_TO_MINIMAP, REMOVE_STRUCTURE_NODE_FROM_MINIMAP, INIT_WAVE_TIME, UPDATE_WAVE_TIME, INIT_DISPLAY_GROUP_INFO, DISPLAY_GROUP_INFO, DISPLAY_SINGLE_INFO, HIDE_UNIT_INFO, LENGTH }
