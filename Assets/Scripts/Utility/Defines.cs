...
[System.Serializable]
public enum EObjectType { NONE = -1, UNIT, UNIT_HERO, MAIN_BASE, TURRET, BUNKER, WALL, BARRACK, NUCLEAR, ENEMY_UNIT, ENEMY_STRUCTURE, UNDER_CONSTRUCT, PROCESSING_UPGRADE_STRUCTURE, LENGTH }
...
public enum EFuncButtonCommand { NONE = -1, CANCLE, MOVE, STOP, HOLD, PATROL, ATTACK, LAUNCH_NUCLEAR, LENGTH }
...
public enum EHUDConstructCommand { NONE = -1, DISPLAY_CONSTRUCT_INFO, UPDATE_CONSTRUCT_TIME, UPDATE_CONSTRUCT_STRUCTURE, LENGTH }
public enum EUICommand { NONE = -1, UPDATE_INFO_UI, LENGTH }
public enum ECameraCommand { NONE = -1, WARP_WITH_POS, MOVE_WITH_KEY, MOVE_WITH_MOUSE, ZOOM, LENGTH }
public enum ESelectCommand { NONT = -1, TEMP_SELECT, TEMP_UNSELECT, SELECT_START, SELECT_FINISH, LENGTH }
