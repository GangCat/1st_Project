...
public enum EHUDCommand { NONE = -1, ADD_STRUCTURE_NODE_TO_MINIMAP, REMOVE_STRUCTURE_NODE_FROM_MINIMAP, INIT_WAVE_TIME, UPDATE_WAVE_TIME, INIT_DISPLAY_GROUP_INFO, INIT_DISPLAY_SINGLE_INFO, DISPLAY_GROUP_INFO, DISPLAY_SINGLE_INFO, HIDE_UNIT_INFO, HERO_RESURRECTION_UPDATE, HERO_RESSURECTION_FINISH, DISPLAY_SPAWN_UNIT_INFO, FINISH_SPAWN_UNIT, UPDATE_SPAWN_UNIT_PROGRESS, HIDE_ALL_INFO, LENGTH }
public enum EHUDUpgradeCommand { NONE = -1, MAIN_BASE, STRUCTURE, UNIT, DISPLAY, UPDATE_PROGRESS, FINISH, LENGTH };
