...
[System.Serializable]
public enum ESelectableObjectType { None = -1, UNIT, HERO, MAIN_BASE, TURRET, BUNKER, WALL, BARRACK, NUCLEAR, ENEMY_UNIT, ENEMY_STRUCTURE, LENGTH }
...
public enum EMainStructureCommnad { NONE = -1, CANCLE, CONFIRM, BUILD_TURRET, BUILD_BUNKER, BUILD_WALL, BUILD_NUCLEAR, BUILD_BARRACK, DEMOLITION, UPGRADE, LENGTH }
public enum EBarrackCommand { NONE = -1, CANCLE, SPAWN_MELEE, SPAWN_RANGE, SPAWN_ROCKET, RALLYPOINT, DEMOLITION, UPGRADE, LENGTH }