...
[System.Serializable]
public enum EObjectType { NONE = -1, UNIT, UNIT_HERO, MAIN_BASE, TURRET, BUNKER, WALL, BARRACK, NUCLEAR, ENEMY_UNIT, ENEMY_STRUCTURE, UNDER_CONSTRUCT, PROCESSING_UPGRADE_STRUCTURE, PROCESSING_DEMOLISH, LENGTH }
...
public enum EUnitFuncButtonCommand { NONE = -1, CANCLE, MOVE, STOP, HOLD, PATROL, ATTACK, LAUNCH_NUCLEAR, LENGTH }
public enum EMainbaseCommnad { NONE = -1, CANCLE, CONFIRM, BUILD_STRUCTURE, LENGTH }
