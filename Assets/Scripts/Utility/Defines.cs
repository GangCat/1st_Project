...
[System.Serializable]
public enum EObjectType { NONE = -1, UNIT, UNIT_HERO, MAIN_BASE, TURRET, BUNKER, WALL, BARRACK, NUCLEAR, ENEMY_UNIT, ENEMY_STRUCTURE, HBEAM, PROCESSING_UPGRADE_STRUCTURE, UNDER_CONSTRUCT_STRUCTURE, LENGTH }
...
public enum EHUDUpgradeCommand { NONE = -1, DISPLAY_UPGRADE_INFO, UPDATE_PROGRESS, LENGTH }
public enum EHUDSpawnUnitCommand { NONE = -1, UPDATE_SPAWN_UNIT_LIST, UPDATE_SPAWN_UNIT_TIME, DISPLAY_SPAWN_UNIT_INFO, LENGTH }
