...
public class AudioPlayer_Friendly_U02 : AudioPlayerBase
{
    ...
    public void PlayAudio(EAudioType_Friendly_U02 _audioType)
    {
        for (int i = 0; i < audioPlayers.Length; ++i)
        {
    ...
    */
    ...
    public enum EAudioType_Friendly_U02 { NONE = -1, PRODUCE, SELECT_01, SELECT_02, SELECT_03, ORDER_01, ORDER_02, ORDER_03, ORDER_04, ATTACK, LENGTH } 
}
